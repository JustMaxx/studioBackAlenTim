...
module.exports = function (app){
  ...
  app.post('/api/order/addNewOrderByAdmin',controller.addNewOrderByAdmin)
  app.post('/api/order/uploadImage',uploadImage.array('images'), controller.updateImage)
  app.post('/api/order/uploadImageByAdmin',uploadImage.array('images'), controller.updateImageByAdmin)
